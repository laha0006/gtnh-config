...
- serverutils, enabled ranks & commands (for /hoem, /back, /tpa, /spawn etc), chunkloading, and more claimed chunks, and loaded chunks.
- ranks.txt (homes, back, tpa, etc 0warmup, 0cd, max 10 homes)
